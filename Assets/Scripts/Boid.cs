...
public class Boid : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        while (randColor.r + randColor.g + randColor.b < 1.0f) //Окрасить птицу в случайный цвет, но не слишком темный
        {
    ...
    void LookAhead()                        // Ориентировать птицу клювом в направлении полета
    {
